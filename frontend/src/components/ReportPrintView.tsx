...
export const ReportPrintView: React.FC<Props> = ({ input, result }) => {
    ...
    return (
        <div className="print-only">
            {/* Cover Page */}
            <div className="print-page mb-8 text-center" style={{ pageBreakAfter: 'always' }}>
                <h1 className="text-4xl font-bold mb-4 mt-20">은퇴 시뮬레이션 리포트</h1>
                <p className="text-xl text-gray-500 mb-8">{new Date().toLocaleDateString()} 생성</p>
            ...
            <div className="print-page" style={{ pageBreakAfter: 'always' }}>
                ...
                <div className="h-64 border rounded p-2 mb-8">
