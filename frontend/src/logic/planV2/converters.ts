...
function mergePlanWithSnapshot(existingPlan: SimulationPlanV2, derivedPlan: SimulationPlanV2): SimulationPlanV2 {
    return {
        ...
        withdrawalPolicy: {
            ...
            taxCredit: {
                ...existingPlan.withdrawalPolicy.taxCredit,
                ...derivedPlan.withdrawalPolicy.taxCredit
            },
            healthInsurance: {
                ...existingPlan.withdrawalPolicy.healthInsurance,
                ...derivedPlan.withdrawalPolicy.healthInsurance
            },
            rebalancing: {
                ...existingPlan.withdrawalPolicy.rebalancing,
                ...derivedPlan.withdrawalPolicy.rebalancing
            },
            severance: {
                ...existingPlan.withdrawalPolicy.severance,
                ...derivedPlan.withdrawalPolicy.severance
            },
            reverseAnnuity: {
                ...existingPlan.withdrawalPolicy.reverseAnnuity,
                ...derivedPlan.withdrawalPolicy.reverseAnnuity
            }
        },
...
export function legacyInputToPlanV2(input: SimulationInput): SimulationPlanV2 {
    ...
    const incomeStreams: SimulationPlanV2["incomeStreams"] = [];
    ...
    const oneOffEvents: PlanExpenseEvent[] = (input.events ?? []).map((event, index) => ({
        id: `event_${index + 1}`,
